...
import { fetchAllTasks } from "../lib/dbService";
...
export default function ProgressTracker({ currentUser, employees, allTasks, projects }: ProgressTrackerProps) {
            ...
            {memberMetrics.map(({ employee, assigned, inProgress, completed, total, completionRate }) => (
              <div key={employee.phone} className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <div className="h-9 w-9 bg-slate-100 border border-slate-200 rounded-full grid place-content-center text-xs font-extrabold text-slate-700">
