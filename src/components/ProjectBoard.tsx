            ...
            <div className="flex -space-x-2 overflow-hidden mr-2">
              {projectMembers.map((emp) => (
                <div 
                  ...
                  className="inline-block h-8 w-8 rounded-full ring-2 ring-white bg-indigo-100 flex items-center justify-center text-[10px] font-bold text-indigo-800 border border-indigo-200"
                >
  ...
  return (
    <div className={`p-4 rounded-xl border shadow-sm transition-all flex flex-col gap-3 group ${
      ...
      <div>
        ...
        {task.description && (
          <p className={`text-xs mt-1 line-clamp-3 leading-relaxed whitespace-pre-wrap ${
...
function SentTasksTrackerPanel({ userTasks, currentUser, employees, selectedProject, formatFileSize }: SentTasksTrackerPanelProps) {
